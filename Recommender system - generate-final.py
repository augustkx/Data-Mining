...
#    print('11111111111',datasam.columns)
...
#    print('22222222222222',datasam.columns)
...
#    print('3333333333',datasam.columns)
...
#=======================================================================================================================
def main(data,test,feat,plot_parameter):
    """
...
#    rows_train = random.sample(list(data['srch_id'].unique()), 50)#select 50 srch_id randomly,used when modeling selecting.
    rows_train = random.sample(list(data['srch_id'].unique()), 100)#used when taining the whole data for the last outcome to hand up.
...
#    print('ndcg_randomforest:',ndcg_randomforest,';   ndcg_GradientBoosting:',ndcg_GradientBoosting,';   ndcg_SVM:', ndcg_SVM)
    print(' ndcg_GradientBoosting:', ndcg_GradientBoosting)#used when taining the whole data for the last outcome 
    ndcg_GradientBoosting.to_csv('final.csv', index = False)#used when taining the whole data for the last outcome 
...
#[feat, test] = createfeat(test)#second set
[feat, test] = new_feat(test)
#print(test.columns)
main(data,test,feat,'')
